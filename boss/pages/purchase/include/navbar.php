    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="purchase.php">Bon Commande</a>
    ...
    <li class="nav-item">
            ...
            <span>Employees</span>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../employees/listEmp/employees list.php"> Employees List</a>
                <a class="collapse-item" href="../employees/absence/absence.php"> Attendance list</a>
                                <a class="collapse-item"  href="../employees/salary/salary.php"> Salary</a>
                    </div>
                </div>
            </li>
